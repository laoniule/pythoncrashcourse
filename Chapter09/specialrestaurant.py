...
class IceCreamStand(Restaurant):
    def __init__(self,restaurant_name,cuisine_type):
        ...
        self.icecreamstandList=["berry","chocalate","milk"]

    def get_describe_icecream_kind(self):
        print("My shop has some kind icecream below: ")
        for kind in self.icecreamstandList:
            print(kind)
...
myicecereamstand=IceCreamStand("bingmei","ice drink")
myicecereamstand.description_restaurant()
myicecereamstand.get_describe_icecream_kind()